	...
	<div class="list_warp">
		...
		<div class="list_right">
			...
			<div class="nei" style="text-align:center;font-size:30px">
				...
				<form action="${website}/admin/newColumn" method="post">

					<h2 align="center">增加栏目</h2>
					<div
						style="text-align: center; line-height: 25px; font-size: 12px;">

						<input type="text" name="columnName" placeholder="栏目名称" required><br><br>
						<input type="hidden" name="columnState" value="1"><br><br>
