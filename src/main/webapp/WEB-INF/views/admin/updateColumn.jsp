...
<script type="text/javascript">
    //注册情况提示
    var existedError = '<%=request.getAttribute("existedError") == null ? "" : request.getAttribute("existedError")%>'

    if(existedError != null && existedError != '') {
        alert(existedError);
    }
</script>
...
<div class="list_warp">
	<div class="list_left">
		...
		<div class="list_right">
			...
			<form action="${website}/admin/updateColumn" method="post">

				<h2 align="center">编辑栏目</h2>
				<div style="text-align: center; line-height: 25px; font-size: 12px;">

					<input type="hidden" name="columnId" value="${column.columnId}" required><br>
					<input type="text" name="columnName" value="${column.columnName}" required><br>
					<input type="hidden" name="columnState" value="${column.columnState}" required><br>
